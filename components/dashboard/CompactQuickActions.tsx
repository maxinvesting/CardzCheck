    ...
    <section className="rounded-xl border border-[color:var(--biz-border,#e5e7eb)] bg-[color:var(--biz-surface,#ffffff)] p-4">
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
        ...
        <button
          type="button"
          onClick={onAddCard}
          className="inline-flex items-center justify-center gap-2 rounded-lg border border-[color:var(--biz-primary-border)] bg-[color:var(--biz-primary)] px-3 py-2 text-xs font-semibold text-[color:var(--biz-primary-foreground)] shadow-sm transition-colors hover:bg-[color:var(--biz-primary-hover)]"
        >
