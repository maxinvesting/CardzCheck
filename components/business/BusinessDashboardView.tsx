    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Link
            ...
            className="px-3 py-1.5 rounded-md bg-emerald-600 hover:bg-emerald-700 text-white transition-colors text-xs font-medium whitespace-nowrap flex items-center gap-1.5"
          >
      ...
      {needsMigration && (
        <div
          ...
          className="rounded-xl p-4 bg-amber-900/20 text-amber-300 text-sm"
        >
            ...
            {ebayAccount?.connected ? (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="rounded-md border border-white/10 px-3 py-1.5 text-xs font-medium text-slate-300 hover:border-white/20 hover:text-white transition-colors"
                >
                  Import
                </button>
                <Link
                  href="/business/ledger"
                  className="rounded-md bg-[#86b817] hover:bg-[#79a814] px-3 py-1.5 text-xs font-semibold text-white transition-colors"
                >
                  View Listings
                </Link>
              </div>
      ...
      {!needsMigration && (
        <div
          ...
          className="rounded-xl bg-amber-900/10 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"
        >
          ...
          <Link
            ...
            className="shrink-0 px-3 py-1.5 rounded-md border border-amber-600/40 bg-amber-900/20 text-amber-300 hover:bg-amber-900/30 hover:border-amber-600/60 text-xs font-medium transition-colors whitespace-nowrap"
          >
          ...
          <div className="space-y-5">
            ...
            <Surface title="Quick Actions">
              <div className="grid grid-cols-2 gap-2">
                <Link
                  href="/business/ledger"
                  className="flex items-center gap-2 px-3 py-2.5 rounded-md bg-emerald-600 hover:bg-emerald-700 text-white transition-colors text-xs font-medium"
                >
                ...
                <a
                  href="/api/business/export?type=inventory"
                  className="flex items-center gap-2 px-3 py-2.5 rounded-md border border-white/10 text-slate-300 hover:border-white/20 hover:text-white transition-colors text-xs font-medium"
                >
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {ebayStoreHref ? (
                  ...
                  <Link
                    href="/business/settings"
                    className="flex items-center gap-2 px-3 py-2.5 rounded-md border border-white/10 text-slate-400 hover:border-white/20 hover:text-slate-300 transition-colors text-xs font-medium"
                  >
                    <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
                ...
                <Link
                  href="/business/grade-probability"
                  className="flex items-center gap-2 px-3 py-2.5 rounded-md border border-amber-600/30 bg-amber-900/10 text-amber-300 hover:bg-amber-900/20 transition-colors text-xs font-medium"
                >
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                  </svg>
