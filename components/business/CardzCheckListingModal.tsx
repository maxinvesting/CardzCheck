        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <ModeCard
              ...
              body="We sell at market value and manage the price for you (auto-reduces 7.5% at day 30)."
            />
            <ModeCard
          ...
          {mode === "cardzcheck" ? (
            <div className="mt-4 border border-[#1F5F45] bg-[#0E251B] px-3 py-3">
              <div className="text-[10px] font-medium uppercase tracking-[0.08em] text-[#20B26B]">
                List price (locked to market value)
              </div>
              <div className="mt-1 font-data text-xl font-semibold tabular-nums text-[#E6E8EB]">
                {fmtCents(cmvCents)}
              </div>
              {cmvCents == null ? (
                <div className="mt-1 text-[11px] text-[#E05C5C]">
                  No market value available for this card yet — set your own price instead.
                </div>
              ) : null}
            </div>
          ) : (
